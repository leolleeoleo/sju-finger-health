...
${OBJECTDIR}/src/state.o: src/state.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/state.o src/state.c

${OBJECTDIR}/src/ra8806.o: src/ra8806.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ra8806.o src/ra8806.c
...
${OBJECTDIR}/src/iic.o: src/iic.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/iic.o src/iic.c

${OBJECTDIR}/src/lcd1602.o: src/lcd1602.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/lcd1602.o src/lcd1602.c

${OBJECTDIR}/src/lcd.o: src/lcd.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/lcd.o src/lcd.c
...
${OBJECTDIR}/src/uart.o: src/uart.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/uart.o src/uart.c

${OBJECTDIR}/src/iap.o: src/iap.asm 
	${MKDIR} -p ${OBJECTDIR}/src
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/src/iap.o src/iap.asm

${OBJECTDIR}/src/base.o: src/base.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/base.o src/base.c
...
${OBJECTDIR}/src/keyboard.o: src/keyboard.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/keyboard.o src/keyboard.c

${OBJECTDIR}/src/tfs_m51.o: src/tfs_m51.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/tfs_m51.o src/tfs_m51.c

${OBJECTDIR}/src/touch.o: src/touch.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/touch.o src/touch.c

${OBJECTDIR}/src/sim300.o: src/sim300.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sim300.o src/sim300.c

${OBJECTDIR}/src/sc16is752.o: src/sc16is752.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sc16is752.o src/sc16is752.c

${OBJECTDIR}/src/flash.o: src/flash.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/flash.o src/flash.c
